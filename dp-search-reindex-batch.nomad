job "dp-search-reindex-batch" {
  ...
  group "web" {
    ...
    task "dp-search-reindex-batch-web" {
      driver = "docker"
      ...
      vault {
        policies = ["dp-search-reindex-batch-web"]
      }
    }
  }
  ...
  group "publishing" {
    ...
    task "dp-search-reindex-batch-publishing" {
      driver = "docker"
      ...
      vault {
        policies = ["dp-search-reindex-batch-publishing"]
      }
    }
  }
}
